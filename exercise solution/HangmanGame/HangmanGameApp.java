...
public class HangmanGameApp{
    ...
    private static String chooseWord(Vector<String> v){    //매개변수로 들어온 벡터로부터 랜덤하게 단어를 한 개 선택하여 리턴한다.
        int r = (int)(Math.random() * v.size());
        String temp = v.get(r);
        return temp;
    }
    
    private static Vector<String> makeVector(){        //words.txt로부터 불러온 단어들을 벡터에 저장을 한다.
    ...
    private static void gameProcess(Vector<String> v, String word){    
